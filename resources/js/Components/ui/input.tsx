        ...
        return (
            <input
                ...
                className={cn(
                    ...
                    'bg-white dark:bg-gray-900 px-3 py-1 text-sm text-gray-900 dark:text-white',
                    'shadow-sm transition-colors placeholder:text-gray-400 dark:placeholder:text-gray-500',
