...
export default function DreCreate({ categories, period_types, scenarios }: Props) {
  const [formData, setFormData] = useState({
    period_type: 'monthly',
    year_month: new Date().toISOString().slice(0, 7), // YYYY-MM
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await router.post(route('dres.store'), formData, {
        onSuccess: () => {
      ...
      console.error('Error creating DRE:', error);
      setIsSubmitting(false);
    }
  };
    ...
    <>
      ...
      <div className="space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Criar Novo DRE</h1>
            <p className="text-muted-foreground">
              Gere um novo Demonstrativo de Resultados do Exercício
            </p>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Confira as configurações antes de gerar
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <p className="text-sm">
                      {period_types.find(pt => pt.value === formData.period_type)?.label || 'N/A'}
                    </p>
                  </div>
              ...
              <Alert>
                ...
                <AlertDescription>
                  O DRE será gerado com base nas transações do período selecionado.
                  Você poderá visualizar e exportar o resultado após a geração.
                </AlertDescription>
              </Alert>
